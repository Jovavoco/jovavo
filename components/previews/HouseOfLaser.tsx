...
>
  ...
  <div className="relative mx-auto max-w-[1600px] px-5 pt-12 sm:px-8 sm:pt-14 lg:px-12 lg:pt-16 xl:px-16">
    <div className="relative min-h-[640px] overflow-hidden rounded-[70px_70px_0_0] sm:min-h-[680px] sm:rounded-[120px_120px_0_0] lg:min-h-[720px] lg:rounded-[220px_220px_0_0]">
      <img
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_43%,rgba(243,238,232,0.84)_0%,rgba(243,238,232,0.52)_40%,rgba(243,238,232,0.15)_75%,transparent_100%)]" />

      {/* ABSTRACT DETAILS */}
      <div className="pointer-events-none absolute -left-[17%] -top-[42%] hidden h-[760px] w-[760px] rounded-full border border-[#8F7C6E]/20 lg:block" />

      <div className="pointer-events-none absolute -bottom-[54%] -right-[18%] hidden h-[700px] w-[700px] rounded-full border border-[#8F7C6E]/15 lg:block" />

      {/* LEFT EDGE */}
      <div className="absolute left-[6%] top-[13%] z-10 hidden lg:block">
        <div className="h-12 w-px bg-[#8F7C6E]/30" />

        <p className="mt-5 text-[6px] font-light uppercase leading-[2.1] tracking-[0.44em] text-[#79695F]/65">
          Brooklyn
          <br />
          New York
        </p>
      ...
      {/* RIGHT EDGE */}
      <div className="absolute right-[6%] top-[13%] z-10 hidden lg:block">
      ...
      {/* MAIN MESSAGE */}
      <div className="relative z-10 flex min-h-[640px] items-center justify-center px-7 pb-32 pt-20 text-center sm:min-h-[680px] sm:px-10 lg:min-h-[720px] lg:pb-36">
        <div className="mx-auto flex max-w-[780px] flex-col items-center">
          ...
          >
            <span className="block text-[50px] leading-[0.89] text-[#29231F] sm:text-[61px] md:text-[70px] lg:text-[77px] xl:text-[84px]">
              A little time
            </span>

            <span className="mt-1 block text-[52px] italic leading-[0.89] text-[#967E6D] sm:text-[63px] md:text-[72px] lg:text-[79px] xl:text-[86px]">
              just for you.
            </span>
          </h2>
          ...
          <p className="mt-7 max-w-[520px] text-[12px] font-light leading-[1.95] tracking-[0.015em] text-[#625A55] sm:text-[13px]">
            Laser, skincare, beauty, and self-care in a warm Brooklyn
            space where every treatment feels personal.
          </p>
        </div>
      </div>
    </div>
  ...
  {/* =====================================================
      OVERLAPPING VISIT PANEL
  ===================================================== */}

  <div
    id="contact"
    className="relative z-20 mx-auto -mt-20 max-w-[1260px] px-7 sm:-mt-24 sm:px-12 lg:-mt-28 lg:px-16"
  >
    <div className="relative overflow-hidden bg-[#E8DDD4]/95 shadow-[0_30px_80px_rgba(72,57,47,0.08)] backdrop-blur-md">
      {/* SMALL DECORATIVE ARC */}
      <div className="pointer-events-none absolute -right-[180px] -top-[210px] h-[380px] w-[380px] rounded-full border border-[#8D786A]/10" />

      {/* HEADER */}
      <div className="relative grid gap-8 border-b border-[#77695F]/15 px-7 py-10 sm:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:px-12 lg:py-12 xl:px-14">
        <div>
          <p className="text-[6px] font-light uppercase tracking-[0.48em] text-[#8C786B]">
            Visit House of Laser
          </p>

          <h3
            className={`${bodoni.className} hls-bodoni mt-5 font-normal tracking-[-0.05em]`}
          >
            <span className="block text-[38px] leading-[0.94] text-[#302925] sm:text-[45px] lg:text-[50px]">
              Your beauty
            </span>

            <span className="block text-[40px] italic leading-[0.94] text-[#967E6D] sm:text-[47px] lg:text-[52px]">
              destination.
            </span>
          </h3>
        </div>

        <p className="max-w-[430px] text-[11px] font-light leading-[1.9] text-[#655D57] sm:text-[12px] lg:ml-auto">
          Visit our Brooklyn studio, connect with us, and find the
      ...
      <div className="relative grid lg:grid-cols-2">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group flex items-center justify-between gap-7 border-b border-[#77695F]/15 px-7 py-9 transition-colors duration-500 hover:bg-[#E2D5CB] sm:px-10 lg:border-b-0 lg:border-r lg:px-12 lg:py-11 xl:px-14"
        >
          <div className="flex items-start gap-5">
            <div className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#897468]/25">
              <MapPin
                size={12}
                strokeWidth={1}
            ...
            <div>
              <p className="text-[6px] font-light uppercase tracking-[0.44em] text-[#897468]">
                Find Us
              </p>

              <p
                className={`${bodoni.className} hls-bodoni mt-3 text-[22px] font-normal leading-[1.22] tracking-[-0.025em] text-[#302925] sm:text-[25px]`}
              >
              ...
              <div className="mt-4 flex items-center gap-3">
                <span className="text-[6px] font-light uppercase tracking-[0.36em] text-[#6E625A]">
                  Directions
                </span>

                <span className="h-px w-7 bg-[#75675E]/35 transition-all duration-500 group-hover:w-11" />
              </div>
            </div>
          </div>
          ...
          <ArrowRight
            size={14}
            strokeWidth={1}
            className="shrink-0 text-[#6E625A] transition-transform duration-500 group-hover:translate-x-1"
          />
        </a>

        {/* CONTACT */}
        <div className="flex items-center justify-between gap-7 px-7 py-9 sm:px-10 lg:px-12 lg:py-11 xl:px-14">
          <div className="flex items-start gap-5">
            <div className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#897468]/25">
              <Phone
                size={12}
            ...
            <div>
              ...
              <a
                ...
                className={`${bodoni.className} hls-bodoni mt-3 block w-fit text-[23px] font-normal tracking-[-0.025em] text-[#302925] transition-colors duration-300 hover:text-[#967E6D] sm:text-[26px]`}
              >
                (929) 833-9197
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-2 block w-fit text-[9px] font-light tracking-[0.025em] text-[#6A605A] transition-colors duration-300 hover:text-[#302925]"
              >
                @houseoflaserspa
              </a>
            </div>
  ...
  >
    {/* GLOW */}
    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_72%_35%,rgba(190,161,138,0.12),transparent_42%)]" />

    {/* LARGE CURVES */}
    <div className="pointer-events-none absolute -left-[360px] -top-[430px] hidden h-[720px] w-[720px] rounded-full border border-[#C9AD98]/10 lg:block" />

    <div className="pointer-events-none absolute -bottom-[430px] -right-[280px] hidden h-[700px] w-[700px] rounded-full border border-[#C9AD98]/10 lg:block" />
    ...
    <div className="relative mx-auto max-w-[1450px] px-7 py-16 sm:px-10 sm:py-20 md:px-14 lg:px-16 lg:py-24 xl:px-20">
      <div className="grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-24">
        ...
        <div>
          ...
          >
            <span className="block text-[46px] leading-[0.91] text-[#F6F2EE] sm:text-[56px] md:text-[64px] lg:text-[68px] xl:text-[74px]">
              Make time
            </span>

            <span className="mt-1 block text-[48px] italic leading-[0.91] text-[#C7B29F] sm:text-[58px] md:text-[66px] lg:text-[70px] xl:text-[76px]">
              for yourself.
            </span>
          </h2>

          <p className="mt-7 max-w-[450px] text-[12px] font-light leading-[1.9] text-white/45 sm:text-[13px]">
            Your next treatment starts with a little time set aside
            just for you.
          </p>
        </div>
        ...
        <div className="lg:pl-6">
          <a
            href="tel:+19298339197"
            className="group flex items-center justify-between gap-8 border-b border-white/30 pb-6"
          >
            <div>
              ...
              <p
                className={`${bodoni.className} hls-bodoni mt-3 text-[27px] font-normal tracking-[-0.025em] text-white sm:text-[31px]`}
              >
                Book an appointment
              </p>
            </div>
          ...
          >
            ...
            <span className="h-px w-11 bg-white/20 transition-all duration-500 group-hover:w-20 group-hover:bg-white/45" />
          </a>
        </div>
      </div>

      {/* BOTTOM DETAIL */}
      <div className="mt-16 flex items-center gap-6 border-t border-white/[0.07] pt-7">
