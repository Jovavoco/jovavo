          ...
          <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-8 max-w-2xl text-lg leading-relaxed text-[#1b1713]/55 md:text-xl">
                ...
                systems, and growth tools for brands, businesses, creators, and
                organizations ready to build a stronger online presence.
              </p>

              <Link
                href="#services"
                className="mt-9 inline-flex w-fit items-center gap-3 rounded-full border border-[#1b1713]/15 px-7 py-3 text-[11px] uppercase tracking-[0.28em] text-[#1b1713] transition hover:-translate-y-1 hover:bg-[#1b1713] hover:text-white"
              >
                Explore Services
